# These code are from https://github.com/kevin28520/My-TensorFlow-tutorials/tree/master/01%20cats%20vs%20dogs
...
train_dir = '/Users/sherry/Documents/Study/CS 6220/HW01/HW01_20190901/01_cats_vs_dogs/data/train_5k/'
...
def get_batch(image, label, image_W, image_H, batch_size, capacity):
    ...
    # _image_with_crop_or_pad
    image = tf.image.resize_image_with_crop_or_pad(image, image_W, image_H) 
    # NEAREST_NEIGHBOR resize_images
    # image = tf.image.resize_images(image, size=[image_W,image_H], method=tf.image.ResizeMethod.NEAREST_NEIGHBOR)
